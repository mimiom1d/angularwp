...
?>
<tr class="gcacf-field gcacf-field-true-false gcacf-field-setting-conditional_logic" data-type="true_false" data-name="conditional_logic">
	<td class="gcacf-label">
		<label><?php _e("Conditional Logic",'gcacf'); ?></label>
	</td>
	<td class="gcacf-input">
		<?php 
		
		gcacf_render_field(array(
			'type'			=> 'true_false',
		...
		<div class="rule-groups" <?php if($disabled): ?>style="display:none;"<?php endif; ?>>
			...
			<?php foreach( $field['conditional_logic'] as $group_id => $group ): 
				...
				$h4 = ($group_id == "group_0") ? __("Show this field if",'gcacf') : __("or",'gcacf');
				...
				<div class="rule-group" data-id="<?php echo $group_id; ?>">
					...
					<table class="gcacf-table -clear">
						...
						<?php foreach( $group as $rule_id => $rule ): 
							...
							?>
							<tr class="rule" <?php gcacf_esc_attr_e($attributes); ?>>
								<td class="param">
									<?php 
								...
								<td class="add">
									<a href="#" class="button add-conditional-rule"><?php _e("and",'gcacf'); ?></a>
								</td>
								<td class="remove">
									<a href="#" class="gcacf-icon -minus remove-conditional-rule"></a>
								</td>
								</tr>
							<?php endforeach; ?>
						</tbody>
			...
			<a href="#" class="button add-conditional-group"><?php _e("Add rule group",'gcacf'); ?></a>
