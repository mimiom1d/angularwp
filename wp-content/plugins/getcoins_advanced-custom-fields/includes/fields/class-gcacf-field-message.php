...
if( ! class_exists('gcacf_field_message') ) :

class gcacf_field_message extends gcacf_field {
	...
	*/
	...
	function render_field_settings( $field ) {
		...
		// HTML
		gcacf_render_field_setting( $field, array(
			'label'			=> __('Escape HTML','gcacf'),
			'instructions'	=> __('Allow HTML markup to display as visible text instead of rendering','gcacf'),
			'name'			=> 'esc_html',
			'type'			=> 'true_false',
			'ui'			=> 1,
		));
...
// initialize
gcacf_register_field_type( 'gcacf_field_message' );
