...
if( ! class_exists('gcacf_location_post_status') ) :

class gcacf_location_post_status extends gcacf_location {
	...
	*/
	...
	function initialize() {
		...
		$this->label = __("Post Status",'gcacf');
		$this->category = 'post';
	...
	*/
	...
	function rule_match( $result, $rule, $screen ) {
		...
		// vars
		$post_status = gcacf_maybe_get( $screen, 'post_status' );
...
// initialize
gcacf_register_location_rule( 'gcacf_location_post_status' );
