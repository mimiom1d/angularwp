...
if( ! class_exists('gcacf_field_link') ) :

class gcacf_field_link extends gcacf_field {
...
<div <?php gcacf_esc_attr_e($div); ?>>
	...
	<div class="gcacf-hidden">
		...
		<?php foreach( $link as $k => $v ): ?>
			<?php gcacf_hidden_input(array( 'class' => "input-$k", 'name' => $field['name'] . "[$k]", 'value' => $v )); ?>
		<?php endforeach; ?>
	</div>
	
	<a href="#" class="button" data-name="add" target=""><?php _e('Select Link', 'gcacf'); ?></a>
	...
	<div class="link-wrap">
		...
		<i class="gcacf-icon -link-ext gcacf-js-tooltip" title="<?php _e('Opens in a new window/tab', 'gcacf'); ?>"></i><?php
		?><a class="gcacf-icon -pencil -clear gcacf-js-tooltip" data-name="edit" href="#" title="<?php _e('Edit', 'gcacf'); ?>"></a><?php
		?><a class="gcacf-icon -cancel -clear gcacf-js-tooltip" data-name="remove" href="#" title="<?php _e('Remove', 'gcacf'); ?>"></a>
	</div>
	...
	*/
	...
	function render_field_settings( $field ) {
		...
		gcacf_render_field_setting( $field, array(
			...
			'layout'		=> 'horizontal',
			'choices'		=> array(
				'array'			=> __("Link Array",'gcacf'),
				'url'			=> __("Link URL",'gcacf'),
			)
		));
...
// initialize
gcacf_register_field_type( 'gcacf_field_link' );
