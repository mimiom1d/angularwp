...
if( ! class_exists('GCACF_Ajax_Query') ) :

class GCACF_Ajax_Query extends GCACF_Ajax {
	
	/** @var array The GCACF field used for querying */
	var $field = false;
	...
	*/
	...
	function response() {
		...
		if( $this->has('field_key') ) {
			$this->field = gcacf_get_field( $this->get('field_key') );
		}
