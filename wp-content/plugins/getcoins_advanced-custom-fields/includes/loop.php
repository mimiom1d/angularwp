...
class gcacf_loop {
	...
	*/
	...
	function add_loop( $loop = array() ) {
		...
		// ensure array
		$loop['value'] = gcacf_get_array( $loop['value'] );
...
function gcacf_add_loop( $loop = array() ) {
	
	return gcacf()->loop->add_loop( $loop );
...
*  gcacf_update_loop
*
*  alias of gcacf()->loop->update_loop()
*
*  @type	function
*  @date	6/10/13
*  @since	5.0.0
...
function gcacf_update_loop( $i = 'active', $key = null, $value = null ) {
	
	return gcacf()->loop->update_loop( $i, $key, $value );
...
function gcacf_get_loop( $i = 'active', $key = null ) {
	
	return gcacf()->loop->get_loop( $i, $key );
...
*  gcacf_remove_loop
*
*  alias of gcacf()->loop->remove_loop()
*
*  @type	function
*  @date	6/10/13
*  @since	5.0.0
...
function gcacf_remove_loop( $i = 'active' ) {
	
	return gcacf()->loop->remove_loop( $i );
