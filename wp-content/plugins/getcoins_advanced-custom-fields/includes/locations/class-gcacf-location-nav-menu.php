...
if( ! class_exists('gcacf_location_nav_menu') ) :

class gcacf_location_nav_menu extends gcacf_location {
	...
	*/
	...
	function rule_match( $result, $rule, $screen ) {
		...
		// vars
		$nav_menu = gcacf_maybe_get( $screen, 'nav_menu' );
...
// initialize
gcacf_register_location_rule( 'gcacf_location_nav_menu' );
