...
if( ! class_exists('gcacf_location_post_taxonomy') ) :

class gcacf_location_post_taxonomy extends gcacf_location {
	...
	*/
	...
	function initialize() {
		...
		$this->label = __("Post Taxonomy",'gcacf');
		$this->category = 'post';
	...
	*/
	...
	function rule_match( $result, $rule, $screen ) {
		...
		$post_terms = gcacf_maybe_get( $screen, 'post_terms' );
		...
		if( $post_terms !== null ) {
			$post_terms = gcacf_maybe_get( $post_terms, $term->taxonomy, array() );
...
// initialize
gcacf_register_location_rule( 'gcacf_location_post_taxonomy' );
