...
if( ! class_exists('gcacf_location_post_type') ) :

class gcacf_location_post_type extends gcacf_location {
	...
	*/
	...
	function rule_values( $choices, $rule ) {
		...
		$post_types = gcacf_get_post_types(array(
			'show_ui'	=> 1, 
		...
		// return choices
		return gcacf_get_pretty_post_types( $post_types );
...
// initialize
gcacf_register_location_rule( 'gcacf_location_post_type' );
