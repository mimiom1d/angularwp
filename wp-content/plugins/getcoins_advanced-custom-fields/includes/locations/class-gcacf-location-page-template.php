...
if( ! class_exists('gcacf_location_page_template') ) :

class gcacf_location_page_template extends gcacf_location {
	...
	*/
	...
	function initialize() {
		...
		$this->label = __("Page Template",'gcacf');
		$this->category = 'page';
	...
	*/
	...
	function rule_match( $result, $rule, $screen ) {
		...
		// return
		return gcacf_get_location_rule('post_template')->rule_match( $result, $rule, $screen );
...
// initialize
gcacf_register_location_rule( 'gcacf_location_page_template' );
